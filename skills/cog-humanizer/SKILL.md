---
name: cog-humanizer
description: Cog Humanizer — rewrite AI-sounding text in a natural human voice. Use when the user says "humanize this", "make it sound natural", "rewrite so it doesn't sound like AI", or pastes AI-generated text for de-robotification. Strips stock AI phrases, varies cadence, preserves meaning.
---
